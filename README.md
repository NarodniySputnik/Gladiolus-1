...
#### SSTV блок
 - параллельно подключен к шине-1 RS-485, шине-2 RS-485, шине 1-Wire
 - Содержит термодатчики 1-Wire
 - Обслуживает бортовой накопитель (модуль SD карты)
 - Делает снимки камерой
 - Изменяет режимы камеры
 - Управляет SSTV передатчиком
 - Несет на борту часы реального времени

#### Модемный блок (2 штуки)
- параллельно подключены к шине-1 RS-485, шине-2 RS-485, шине 1-Wire
- Содержит термодатчики 1-Wire
...
#### Материнский блок
- параллельно подключен к шине-1 RS-485, шине-2 RS-485, шине 1-Wireэ
- Содержит термодатчики 1-Wire
